...
exports.playFirstRound = () => {
  console.log("【1回戦】\n9回裏4対3 2アウト1塁 ");
  console.log(
    "監督「相手はストレートに自信を持っているようだ。特徴を頭に入れて打席に立つんだぞ」\n"
  );

  return comeToBat(pitchInFirstRound);
};

exports.playSemifinals = (highSchool) => {
  ...
  return comeToBat(pitchInSemifinals);
};

exports.playFinal = (highSchool) => {
  ...
  return comeToBat(pitchInFinal);
};

async function comeToBat(pitching) {
